                ...
                <tbody>
                    <?php foreach ($lista_qys as $registro) {?>
                        ...
                        <td><a
                            ...
                            │<a class="btn btn-primary" href="eliminar.php?id=<?php echo $registro['id']; ?>" role="button">Eliminar</a>
                            |<a class="btn btn-primary" href="modificar.php?id=<?php echo $registro['id']; ?>" role="button">editar</a></td>
                    <?php } ?>
